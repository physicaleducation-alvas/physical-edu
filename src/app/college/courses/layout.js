...
export default function CoursesLayout({ children }) {
    ...
    const menuItems = [
        { href: "/college/courses/bped", label: "B.P.ed" },
        { href: "/college/courses/mped", label: "M.P.ed" },
    ];
                ...
                <div className="md:hidden mb-6 mt-6 ">
                    <div className="relative">
                        <button
                            ...
                            className="w-[50%] mx-auto flex items-center justify-between px-5 py-4 bg-white border border-gray-200 rounded-xl shadow-sm text-lg font-medium text-gray-700"
                        >
                        ...
                        {/* Dropdown */}
                        {mobileDropdownOpen && (
                            <div className="absolute  top-full mt-2 w-[50%] mx-auto bg-white border border-gray-200 rounded-xl shadow-lg z-50 overflow-hidden">
                                {menuItems.map((item) => {
