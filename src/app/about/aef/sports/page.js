export default function SportsInfo() {
  return (
    <div className="p-6 leading-relaxed text-justify">
      ...
      <p className="mb-4">
        ...
        Many national and international athletes have been produced by the foundation.
      </p>

      {/* Paragraph 3 */}
      <p className="mb-4">
        Around 120 university players are produced every year who represent the university and bring
        laurels. To date, around 1300 students have represented the university at Inter-University Meets
        in various events and have earned recognition.
      </p>

      {/* Sports List */}
      <h2 className="font-bold text-xl mt-6 mb-3">Sports disciplines under Sports Quota:</h2>

      <ul className="list-disc pl-6 space-y-1 text-lg mb-4">
        <li>Athletics</li>
        <li>Cricket</li>
        <li>Weight lifting and body building</li>
        <li>Handball</li>
        <li>Softball</li>
        <li>Basketball</li>
      ...
      {/* Paragraph 4 */}
      <p className="mb-4">
        Students are selected under the sports quota from various age groups, from primary level
