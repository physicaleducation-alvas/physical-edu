...
{/* CAMPUS INSIGHTS SECTION */}
    <section className="relative w-full py-12 overflow-hidden bg-white mt-13">
      ...
      <div
        className="absolute inset-x-0 top-0 h-64 bg-gradient-to-r from-[#fbb03b] via-[#f8a034] to-[#f58c1f]"
        style={{
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-5 md:gap-6 -mt-4">
          ...
          <article className="bg-white/95 backdrop-blur-sm rounded-3xl shadow-xl border border-orange-50 p-5 md:p-6 relative overflow-hidden hover:-translate-y-1 hover:shadow-2xl transition">
            ...
            <div className="relative">
              <h3 className="text-sm font-semibold text-[#f1861c] uppercase tracking-wide">
                Today on Campus
              </h3>
          ...
          <article className="bg-white/95 backdrop-blur-sm rounded-3xl shadow-xl border border-orange-50 p-5 md:p-6 relative overflow-hidden hover:-translate-y-1 hover:shadow-2xl transition">
            ...
            <div className="relative">
              ...
              <button className="mt-4 inline-flex items-center text-xs font-semibold text-[#f1861c] rounded-full border border-[#f1861c]/40 px-3 py-1.5 hover:bg-[#f1861c]/5 transition">
